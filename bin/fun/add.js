...
export async function add() {
  ...
  if (obj.var === "one") {
    ...
    if (obj.len === "months") {
      ...
      // and they don't let me use [obj.startY, obj.startM]
      let arr = [];
    ...
    if (
      !(await confirm({
        message: `Writing ${obj.var} object "${obj.name}", starting ${
          2000 + obj.startY
        }, ${obj.startM + 1}, ending ${2000 + obj.endY}, ${
          obj.endM + 1
        }, duration ${obj.len}, of value ${obj.val} on months: ${obj.month.join()}\n
              Is this right?`,
      }))
    ) Deno.exit();
